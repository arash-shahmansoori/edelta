...
echo "  - reflection_trajectories.png      (parameter evolution)"
echo "  - reflection_sample_efficiency.png (accuracy vs samples)"
echo "  - reflection_comprehensive.png     (4-panel summary)"
