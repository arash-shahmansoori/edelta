"""
Training script for Data-Dependent Cayley (DDC) Transformer
"""
import os
import sys
import time
...
from proposed_model_ddc import GPTConfig, GPT
...
out_dir = f'out-ddc-{dataset}'
os.makedirs(out_dir, exist_ok=True)

# Setup
tokens_per_iter = gradient_accumulation_steps * batch_size * block_size
print(f"DDC training on {dataset}")
...
print(f"\nDDC Training complete. Best val loss: {best_val_loss:.4f}")
