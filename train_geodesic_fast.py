"""
Training script for the Geodesic-Delta model (FAST with Taylor) (proposed_model.py).
This is a modified version of train.py that imports from proposed_model instead of model.
...
from proposed_model_fast import GPTConfig, GPT
...
init_from = 'scratch' # 'scratch' or 'resume' (no pretrained for geodesic model)
# wandb logging
...
if init_from == 'scratch':
    ...
    print("Initializing a new Geodesic-Delta model (FAST with Taylor) from scratch")
    ...
    raise ValueError(f"Unknown init_from: {init_from}. Geodesic model only supports 'scratch' or 'resume'.")
